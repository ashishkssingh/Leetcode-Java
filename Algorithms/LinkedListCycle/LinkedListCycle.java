...
public class LinkedListCycle {
    ...
    public static ListNode makeLinkedList(Integer[] a) {
    ...
    public static void main(String[] args) {
        Integer[] arr = new Integer[] { 3, 2, 0, -4 };
        ListNode linkedList = makeLinkedList(arr);
        System.out.println(hasCycle(linkedList));
    }
}